...
class Monitor:
    ...
    def __str__(self):
        ...
        return "Monitor ({} drivers, {} riders)".format(
                (self._activities[DRIVER]), (self._activities[RIDER]))
    ...
    def notify(self, timestamp, category, description, identifier, location):
        ...
        print(str(activity.time) + " -- " + str(activity.id) + " " +
    ...
    def _average_total_distance(self):
        ...
        for activities in self._activities[DRIVER].values():
            ...
            # a driver has driven from request to pickup to dropoff if there
            # was no cancel
            # sum the total distance of a driver

            # this is bull but the idea is here
            if len(activities) != 1:
        ...
        return total_distance / driver_count
    ...
    def _average_ride_distance(self):
        ...
        return ride_distance / driver_count
